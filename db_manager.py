...
© 2025 闲鱼自动回复系统"""
    ...
    def get_risk_control_logs(self, cookie_id: str = None, limit: int = 100, offset: int = 0) -> List[Dict]:
        ...
        try:
            with self.lock:
                ...
                if cookie_id:
                    cursor.execute('''
                        SELECT r.id, r.cookie_id, r.event_type, r.event_description,
                               r.processing_result, r.processing_status, r.error_message,
    ...
    def clear_risk_control_logs(self, cookie_id: str = None) -> int:
        ...
        Args:
            cookie_id: 指定账号ID；为None时清空全部风控日志
